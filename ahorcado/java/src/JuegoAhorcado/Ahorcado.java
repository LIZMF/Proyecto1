...
public class Ahorcado {
    ...
    //Dicicionario de palabras disponibles durante el juego
        private String[] diccionario = {"ABEJA", "AEROPUERTO", "COMPUTADOR", "OSO","MEXICO",
        "JAVA", "NEVERA", "PROGRAMA", "INFORMATICA", "COMPUTACION", "COMPUTADOR","CORAZON","PLATANO",
        ...
        "ERROR", "COPA", "PROGRAMADOR", "LICENCIA", "NUEVE", "PROCESADOR","GARAJE","MODERNO","TABLA","DISCOTECA",
    ...
    public Ahorcado(JTextField texto, JLabel loser, JLabel ahorcado){     
        ...
        jt.setText(var);
        lb.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/loser/loser.jpg"))); 
        lb2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/ahorcado/0.jpg"))); 
        JOptionPane.showMessageDialog(null,"La Palabra  Tiene " + this.palabra_secreta.length + " letras ");
        this.play=true;
    }
    ...
    public void evaluar(char word){
        ...
        if(this.intentos==7){ 
           lb2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/ahorcado/8.jpg")));
           lb.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/loser/loser8.jpg")));
           ...
           if(this.cambios==false){
             ...
             lb.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/loser/loser"+this.intentos+".jpg"))); 
             lb2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/ahorcado/"+this.intentos+".jpg")));              
             if(this.intentos<8){
    ...
    private void gano(){
        ...
        if(win==true){                 
             JOptionPane.showMessageDialog(null,"Tuviste "+(this.intentos)+" error."+"\n"+"Pero has ganado !!   Felicidades !!","Winner...",0,new javax.swing.ImageIcon(getClass().getResource("/icon/ahorcado/goals.png")));           
        }       
    }
    
    //desplega las palabras durante el juego de forma aleatoria
